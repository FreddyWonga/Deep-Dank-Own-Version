...
public class FirstPersonController : MonoBehaviour
{
    ...
    void NetworkSetup()
    {
        ...
        {
            Debug.Log("identity.isServer == true");
        ...
        {
            Debug.Log("identity.isServer == false");
            spectator.ResetPlayerInstance();
            if (identity.isLocalPlayer == true)
            {
                SetupSpectator(true);
    ...
    {
        Debug.Log("SetupRemotePlayer Coroutine Started");
        ...
        else
        {
            ...
            Debug.Log("SetupSpectator = false");
        }
    }
